...
plot_fname = "basic-vector-blas.png"

fname = "basic-vector-blas.csv"
...
plt.title("Comparison of Basic VMM, Vector VMM and CBLAS")
...
plt.plot(code2_time, "b-s")
plt.plot(code3_time, "r-o")
#plt.xscale("log")
# plt.yscale("log")
